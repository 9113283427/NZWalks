...
{
    /// <inheritdoc />
    public partial class SeedinddataforDifficultiesandRegions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("31b8c496-7a04-4dbf-94d0-90b53e3c8c57"), "Medium" },
                    { new Guid("913379af-8142-4f2d-a163-a6ccbb11b102"), "Hard" },
                    { new Guid("bfd2cfcf-9796-4cc8-80f6-20a8f47cef39"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("31b8c496-7a04-4dbf-94d0-90b53e3c8c57"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("913379af-8142-4f2d-a163-a6ccbb11b102"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("bfd2cfcf-9796-4cc8-80f6-20a8f47cef39"));
